To link the athlete's profile to an ERC721 token representing the Athlete profile and distribute the minted ERC20 Ludus tokens, you can modify the LudusSocialGraph contract as follows:
